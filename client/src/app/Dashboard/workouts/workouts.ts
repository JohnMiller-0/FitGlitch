...
@Component({
  selector: 'app-workouts',
  standalone: true,
  imports: [CommonModule, LoadingComponent, AddWorkoutComponent, EditWorkoutComponent],
...
export class WorkoutsComponent implements OnInit {
  ...
  addWorkoutFlag: boolean = false; // Flag to indicate if the add workout form is visible
  editWorkoutFlag: boolean = false; // Flag to indicate if the edit workout form is visible
  ...
  editWorkout(workoutId: string): void {
    ...
    this.editWorkoutFlag = true; // Set the flag to show the edit workout form
  }
  ...
  addWorkout(): void {
    ...
    this.addWorkoutFlag = true; // Set the flag to show the add workout form
  }

  handleFormSubmission(): void {
    this.addWorkoutFlag = false;
    this.editWorkoutFlag = false;
    this.getWorkouts(this.todaysDate); // Refresh the workouts list after a new workout has been added
  }
